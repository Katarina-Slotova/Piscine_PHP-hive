...
LIMIT 2, 5;
/* LIMIT’s optional OFFSET argument is placed before the argument indicating the number of returned rows. It indicates the position of the first row returned by LIMIT (i.e. ‘0’ is the first row, 1 is the second row, etc.). */
